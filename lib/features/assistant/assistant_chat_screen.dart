...
class _AssistantChatViewState extends State<_AssistantChatView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Bottom is handled by the input row itself so the composer's background
      // extends into the home-indicator area instead of leaving a bare strip.
      body: SafeArea(
        bottom: false,
        child: Column(
          children: [
                  ...
                  return ResponsiveContentFrame(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final messageIndex = service.isTyping
                            ? index - 1
                            : index;
                        final message =
                            service.messages[service.messages.length -
                                1 -
                                messageIndex];
  ...
  Widget _buildInputArea(BuildContext context, bool isDark) {
    ...
    return Container(
      padding: EdgeInsets.fromLTRB(
        ...
        12,
        responsive.horizontalPadding,
        // Clears the home indicator when the keyboard is down; the keyboard
        // itself already zeroes this inset when it is up.
        12 + responsive.padding.bottom,
      ),
