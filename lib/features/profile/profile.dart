...
class _HelpScreenState extends State<HelpScreen> {
  ...
  static const List<_HelpFaq> _faqs = [
    ...
    (
      ...
      answer:
          'بما أن الحسابات تُدار من قبل إدارة المعهد، يمكنك إرسال طلب حذف الحساب عبر زر "حذف الحساب والبيانات" في قسم "تواصل معنا" أدناه، وستُحذف بياناتك خلال مدة أقصاها ٣٠ يوماً.',
    ),
  ];
        ...
        child: ConstrainedBox(
          ...
          child: ListView(
            ...
            children: [
              ...
              SizedBox(height: responsive.spacing(AppLayout.itemGap)),
              // Accounts here are issued and revoked by the institute rather
              // than self-registered, so deletion runs through the
              // administration. App Review still expects the request path to be
              // reachable from inside the app, which is what this tile is.
              _HelpLinkTile(
                icon: Icons.person_remove_rounded,
                label: 'حذف الحساب والبيانات',
                value: 'أرسل طلباً إلى الإدارة لحذف حسابك وبياناتك',
                actionIcon: Icons.open_in_new_rounded,
                onTap: () => AppLinks.email(
                  context,
                  AppContactInfo.supportEmail,
                  subject:
                      'طلب حذف الحساب والبيانات - ${AppStrings.appShortName}',
                ),
              ).animate().fadeIn(
                delay: motion(370.ms),
                duration: motion(340.ms),
