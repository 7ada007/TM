...
class StudentSubjectGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final gap = responsive.spacing(AppLayout.itemGap);

    final grid = LayoutBuilder(
      builder: (context, constraints) {
        // Column count is driven by the width the tiles actually get, after
        // the page gutters and any tablet centring inset are removed — so a
        // Split View pane on iPad lays out like the phone it is as wide as.
        ...
        final extent = (tileWidth * 1.12).clamp(150.0, 240.0);
